...
export function DashboardHeader() {
  return (
    <div className="mb-8 sm:mb-12">
      <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 animate-slide-up">
        <div className="p-1.5 sm:p-2 bg-gradient-to-br from-primary to-primary/80 rounded-xl animate-scale-in">
      ...
      <p className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed animate-fade-in animate-stagger-1">
